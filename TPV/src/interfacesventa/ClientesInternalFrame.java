...
public class ClientesInternalFrame extends javax.swing.JInternalFrame {
    ...
    private static ClientesInternalFrame instancia;      
    private ModeloTabla modelo;
    
    public static ClientesInternalFrame getVentana() {

        if (instancia == null || instancia.isClosed) {
            instancia = new ClientesInternalFrame();
        }
        return instancia;
    }
    ...
    private void btnAniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAniadirActionPerformed
        AddClientes ventana = new AddClientes(null, true);
